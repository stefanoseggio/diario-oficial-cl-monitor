...
{
  "mcpServers": {
    "delta-registry-diario-oficial-cl-monitor": {
      "command": "npx",
      "args": [
        "-y",
        "mcp-remote",
        "https://mcp.apify.com/?tools=stefano_seggio/diario-oficial-cl-monitor",
        "--header",
...
```json
{
  "mcpServers": {
    "delta-registry-diario-oficial-cl-monitor": {
      "url": "https://mcp.apify.com/?tools=stefano_seggio/diario-oficial-cl-monitor",
      "headers": {
        "Authorization": "Bearer ${APIFY_TOKEN}"
      }
    }
...
```json
{
  "mcpServers": {
    "delta-registry-diario-oficial-cl-monitor": {
      "serverUrl": "https://mcp.apify.com/?tools=stefano_seggio/diario-oficial-cl-monitor",
      "headers": {
